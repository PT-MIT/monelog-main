...
....
    ...
    and the "double" box checked to indicate to MonELOG that the voltage
...
MonELOG supports multiple voltage references, but as a practical
...
look at the status display of the MonELOG.  If reversed,
...
This indicates that MonELOG has recognized that the voltage and 
