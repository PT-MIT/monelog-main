...
MonELOG file systems
---------------------

MonELOG has two file systems. 
...
MonELOG uses that area for limited device specific information. 
This file system uses a flat directory structure, however 
MonELOG presents it as hierarchical through the file manager.
...
*   Display file system
*   Delete files
*   Upload files to the MonELOG
*   Download files from the MonELOG
*   Edit files
...
Files can be uploaded to the MonELOG by clicking the 
...
the file to the MonELOG file system. You can edit the 
...
The MonELOG configuration app was developed exclusively 
using this editor and an MonELOG. 
