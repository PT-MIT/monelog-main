...
MonELOG is capable of storing ten years or more of high resolution data. 
...
access your data directly from the MonELOG:
...
*   You need to see data that is collected by MonELOG but is not being
...
bounds. Data can be grouped by hour, day, week or month. The MonELOG query recognizes
